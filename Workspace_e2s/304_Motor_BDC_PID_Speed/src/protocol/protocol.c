...
void set_computer_value(uint8_t cmd, uint8_t ch, void *data, uint8_t num)
{
  ...
  R_SCI_B_UART_Write (&debug_uart9_ctrl, (uint8_t *)&set_packet, sizeof(set_packet));
  R_SCI_B_UART_Write (&debug_uart9_ctrl, (uint8_t *)data, num);
  R_SCI_B_UART_Write (&debug_uart9_ctrl, (uint8_t *)&sum, sizeof(sum));
}
