...
#define    CP_ID_DOWN_SPEED_RPM    (1513.765f)             /* Speed to start decreasing id [rpm]  (mechanical) */
#define    CP_ID_UP_SPEED_RPM      (1009.177f)             /* Speed to start increasing id [rpm]  (mechanical) */
#define    CP_MAX_SPEED_RPM        (5045.883f)             /* Maximum speed[rpm] (mechanical) */
#define    CP_OVERSPEED_LIMIT_RPM  (7568.824f)             /* Over speed limit [rpm] (mechanical) */
#define    CP_OL_ID_REF            (1.763633f)             /* Id reference when low speed [A] */
