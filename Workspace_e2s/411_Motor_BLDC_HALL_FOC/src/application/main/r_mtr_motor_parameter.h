...
#define    MP_RESISTANCE           (0.42)             		/* Resistance [ohm] */
#define    MP_D_INDUCTANCE         (0.00112f)          /* D-axis inductance [H] */
#define    MP_Q_INDUCTANCE         (0.00112f)          /* Q-axis inductance [H] */
#define    MP_MAGNETIC_FLUX        (0.01119f)          /* Permanent magnetic flux [Wb] */
#define    MP_ROTOR_INERTIA        (0.000003666f)         /* Rotor inertia [kgm^2] */
#define    MP_NOMINAL_CURRENT_RMS  (5.9f)                  /* Nominal current [Arms] */
