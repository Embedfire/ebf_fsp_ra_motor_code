...
#define SW1_ON                   (0)                            /* Active level of SW */
#define SW1_OFF                  (1)                            /* Inactive level of SW */
...
#define MTR_PORT_SW1             (BSP_IO_PORT_11_PIN_14)        /* Input port of SW1 */
#define MTR_PORT_SW2             (BSP_IO_PORT_12_PIN_02)        /* Input port of SW2 */

#define MTR_PORT_LED1            (BSP_IO_PORT_13_PIN_01)        /* Output port of LED1 */
#define MTR_PORT_LED2            (BSP_IO_PORT_13_PIN_03)        /* Output port of LED2 */
//#define MTR_PORT_LED3            (BSP_IO_PORT_13_PIN_03)        /* Output port of LED3 */

#define MOTOR1_ENABLE R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_11_PIN_15, BSP_IO_LEVEL_HIGH)
